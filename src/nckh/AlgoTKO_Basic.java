...
public class AlgoTKO_Basic {
    ...
    public void runAlgorithm(String input, String output, int k, int length_max, int length_min)
        ...
        search(new int[0], null, listItems, length_min, length_max);
     ...
     * @throws IOException
     */
    private void search(int[] prefix, UtilityList pUL, List<UtilityList> ULs, int length_max, int length_min)
            throws IOException {
        MemoryLogger.getInstance().checkMemory();
